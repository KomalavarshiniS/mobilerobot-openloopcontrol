...
## Procedure
tep 1: Use from robomaster import robot

Step 2: Choose the x,y,z - axis movement distance(metres).

Step 3: Give ep_chassis.move to move straight.

step 4: to adjust the speed change the value for x and y

Step 5: Give time.sleep() for a break.

Step 6: Give ep_chassis.drive_speed to have a circular movement.
...
https://youtu.be/nk9GYm9iasU?si=1LaIgqe9jB1Am-hS
